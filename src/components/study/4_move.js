  ...
  return (
    <Grid container>
      ...
      <Grid xs={12} md={8}>
        <Box sx={{ width: "100%", textAlign: "center" }}>
          <Typography variant="body1" gutterBottom>
            ...
            나타내는 내장 타입입니다. 이는 256비트(32바이트)식별자입니다.특정
            주소에서 두가지 요소,모듈과 리소스를 저장할수 있습니다.
          </Typography>
          <Typography variant="body1" gutterBottom>
            주소는 내부적으로 256비트 정수로 되어 있지만 Move주소는 일부러
            불투명한 형태로 설계되었습니다.이는 정수에서주소를 만들거나
            산술연산을 지원하지 않으며수정할수 없다는 의미입니다.c언어에서의
          ...
          <Typography variant="body1" gutterBottom>
            ...
            접근할 수 있지만, 모듈에는 주소 값을 통해 런타임에서 접근할 수
            없습니다.
          </Typography>
        </Box>
      </Grid>
      ...
      <Grid xs={12} md={8}>
        <Box sx={{ width: "100%", textAlign: "center" }}>
          <Typography variant="body1" gutterBottom>
            주소는 두 가지 형태, 즉 명명된(named) 주소와 숫자형 주소로 나눌 수
            있습니다. 명명된 주소의 문법은 Move에서 사용되는 다른 명명된
